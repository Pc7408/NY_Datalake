...
def datalake_solution(file_type,infer_schema,first_row_is_header,delimiter):
  spark.sql("create database if not exists yelp_acadamic_data_raw")


  #BUsiness file
  file_location = "/FileStore/tables/yelp_academic_dataset_business.json"
  ...
  #Checkin file
  file_location = "/FileStore/tables/yelp_academic_dataset_checkin.json"
  # The applied options are for CSV files. For other file types, these will be ignored.
  ...
  #review Data
  file_location = "/FileStore/tables/yelp_review.json"
  # The applied options are for CSV files. For other file types, these will be ignored.
  ...
  #Tip Data
  file_location = "/FileStore/tables/yelp_academic_dataset_tip.json"
  # The applied options are for CSV files. For other file types, these will be ignored.
  ...
  #User Data
  file_location = "/FileStore/tables/yelp_user.json"
...
if __name__ == "__main__":
  ...
  delimiter = ","
  datalake_solution(file_type,infer_schema,first_row_is_header,delimiter)
